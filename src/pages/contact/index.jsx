        ...
        <>
            ...
            <Curve>
                ...
                <div className="mt-24 flex justify-center ">
                    <h1 className="relative text-lg md:text-5xl  bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-600  text-center font-sans ">
                ...
                >
                    ...
                    <div className="w-full  p-4 lg:p-8 mr-16 grid grid-cols-1 content-center justify-items-center">
                        <Calendar onChange={changeForm} error={!!errors.date} bookedDay={form.date}/>
