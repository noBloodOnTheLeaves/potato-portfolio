...
export default function Reviews() {
  return (
      <section className="grid w-full place-content-center overflow-hidden mt-80" style={{height: '400px'}}>
          <Cards/>
      </section>
  )
}
...
const Cards = () => {
    ...
    return (
        <div className="absolute w-full container z-10" ref={containerRef}>
        <Card
...
const Card = ({ containerRef, src, alt, top, left, rotate, className }) => {
    ...
    return (
        <motion.img
            ...
            className={twMerge(
                "drag-elements absolute w-48 bg-neutral-200 p-1 pb-10",
                className
            )}
            src={src}
            alt={alt}
