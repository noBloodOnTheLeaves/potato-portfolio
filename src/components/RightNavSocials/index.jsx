...
export default function RightNavSocials() {
    return (
        ...
        >
            <Magnetic>
                <svg className="mb-4"  onClick={()=> window.open(contact.socials[0].link, 'target')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" color="#ffffff" fill="none">
            ...
            <Magnetic  >
                <svg className="mb-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" color="#ffffff" fill="none">
